...
while intNo_of_skills == 0:
    intNo_of_skills = int(
        input("Enter total number of skill Categories you wish to mention in your resume:"))
...
for i in range(0, intNo_of_skills):
    ...
    strSkillList = input(
        "Enter your list of skills(seperated by comma ','):")
    pdf.printSkillDetail(strCategory, strSkillList)

# Collect Experience details
pdf.resumeHeadings("EXPERIENCE")
intNo_of_CompanyExp = int(
    input("Enter number of Companies you've your experience in:"))
for i in range(0, intNo_of_CompanyExp):
    ...
    pdf.companyExperience(strCompany, strCity, strCountry,
                          strDesignation, strFromDate, strToDate)
...
for i in range(2):
    ...
    strCollege = input(
        "Enter College name from which you have completed your Degree:")
    ...
    pdf.educationDetails(strDegreeName, strCity_of_Degree, strCountry_of_Degree,
                         strCollege, strUniversity, strFromDate_of_Degree, strToDate_of_Degree)
...
if intNo_of_internships != 0:
    ...
    for i in range(0, intNo_of_internships):
        strInternshipDesc = input(
            "Enter your internship Description in one line:")
